...
| `apps/web/src/app/` | Application-level components and routing |
| `apps/web/src/assets/` | Images, fonts, static resources |
| `apps/web/public/` | Files served as-is (favicon, etc.) |
| `apps/api/src/` | Express routes, middleware, services |
