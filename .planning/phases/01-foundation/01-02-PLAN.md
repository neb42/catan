...
3. On 'message' event:
   ...
   - Use discriminated union to handle message types:
     ...
     - **player_ready**: Update player.ready in room, broadcast player_ready to room
...
- [ ] apps/api/src/handlers/websocket.ts handles create_room, join_room, player_ready messages
