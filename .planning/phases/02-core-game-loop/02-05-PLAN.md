...
**Animation**: Use motion.div with y:-20→0 fade-in when component mounts or count changes (resource distribution). Follow CONTEXT.md: "Animate resource cards flying from board to player's hand" - implement key change animation that triggers on resource count increase.
