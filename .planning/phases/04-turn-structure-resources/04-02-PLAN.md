...
<task type="auto">
  ...
  <done>
    - TurnSlice interface added with phase, currentPlayerId, turnNumber, lastDiceRoll, isAnimating
    - setTurnState, setDiceRoll, setAnimating, clearTurnState actions implemented
    - Selector hooks for turn state exported (useTurnPhase, useCanRollDice, etc.)
    - Build succeeds
  </done>
</task>
