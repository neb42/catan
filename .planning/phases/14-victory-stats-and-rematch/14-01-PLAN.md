...
<done>
GameManager instantiates GameStats, records events at all 6+ integration points, includes stats in victory detection.
</done>
</task>

<task type="auto">
  <name>Add statistics to victory message schema</name>
  <files>
    libs/shared/src/schemas/messages.ts
  </files>
  <action>
