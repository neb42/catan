...
Template for `.planning/phases/XX-name/{phase}-USER-SETUP.md` - human-required configuration that Copilot cannot automate.
...
- Steps Copilot can automate (package installs, code changes, file creation)
